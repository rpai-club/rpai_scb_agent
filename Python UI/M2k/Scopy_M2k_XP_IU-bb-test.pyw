...
def MakeMatrixScreen():
    ...
    global FrameBG, BorderSize, ErrConn, FailedPins
    ...
    # 
    SelfTestbutton = Button(frame1, text="Self Test", style="W10.TButton", command=BB_test)
    SelfTestbutton.grid(row=8, column=0, sticky=W, pady=7)
    #
    FailedPins = Label(frame1,text="")
    FailedPins.grid(row=8, column=1, columnspan=4, sticky=W)
##
...
def BB_test():
    ...
    # Configure AWG channel A DC 2.0 V
    AWGAwaveform = numpy.ones(4096) * 2.0
    ## Send waveform
    aout.setCyclic(True)
    aout.push([AWGAwaveform, AWGAwaveform])
    # 
    time.sleep(0.05)
    #
    VOLTAGE_MIN = 1.9
